...
pip install --upgrade --no-cache-dir typing-extensions accelerate datasets sentencepiece protobuf==3.20.* rouge-score nltk py7zr evaluate undecorated tensorflow tensorflow-gpu
